...
namespace WebAPITest2.BusinessTests
{
    ...
    public class AuthManagerTest
    {
        ...
        Mock<IUserService> _mockAuthService;
        ...
        {
            //Arranges
            IAuthService authService = new AuthManager(_mockTokenHelper.Object, _mockAuthService.Object);
            ...
            var claims =_mockAuthService.Setup(us => us.GetClaims(It.IsAny<User>())).Returns(claim.ToList());
            _mockTokenHelper.Setup(th => th.CreateToken(It.IsAny<User>(), It.IsAny<List<OperationClaim>>())).Returns(new AccessToken()
            {
        ...
        public void AuthShouldBeAbleToBeSuccessfullyCreateRegister()
        {
            ...
            _mockAuthService.Setup(u => u.Add(It.IsAny<User>())).Callback(
                (User target) =>
                {
                    _dbUsers.Add(target);
                });
        ...
        public void AuthShouldBeAbleToBeSuccessfullyLogin()
        {
            ...
            _mockAuthService.Setup(u => u.GetByEmail(userForLoginDto.Email)).Returns(_dbUsers.Find(o => o.Email == email));
        ...
        public void AuthShouldBeAbleToBeSuccessfullyCreateUserExists()
        {
            ...
            string email = "ufukcetinkaya-12@hotmail.com";
            _mockAuthService.Setup(us => us.GetByEmail(email)).Returns(_dbUsers.Find(u => u.Email == email));
